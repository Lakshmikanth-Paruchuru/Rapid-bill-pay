...
<body>
    <form id="form1" runat="server">
        ...
        <ul>
            ...
            <li><a href="index.aspx"><asp:Button ID="Button2" runat="server" OnClick="Button2_Click" class="userlogin" Text ="User Login"/></a></li>
    ...
    <object width="1350" height="1000" data="security1.pdf"></object>
    </form>
</body>
</html>
